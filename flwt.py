...
import json
import re
import random   # ← تم إضافته فقط لهذا التعديل
...
# خلط القوائم لعدم وجود تسلسل ثابت (Random Shuffle)
...
def run(target_username, log_callback=None, stop_check=None):
    ...
    # إرسال إشعار تليغرام (مرة واحدة عند بدء الأداة)
